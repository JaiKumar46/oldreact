                        ...
                        {list.map((item,index) => {
                            return (
                                <li key={index} className="single-list">
                                    {
                                        (isEdit===`${index}`) ? <input value={newValue} onChange={e => setNew(e.target.value)}></input> : <h3>{item}</h3>
                                    }
                                    
                                    <div>
                                        <button onClick={handleEdit} listno={index}>{(isEdit===`${index}`) ? `Update`:"Edit"}</button>
